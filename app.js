...
// resize windows
document.querySelector('.fixed_line').style.setProperty('font-size', document.documentElement.clientWidth*0.05 + 'px');
document.querySelector(':root').style.setProperty('--width-mockup', document.documentElement.clientWidth*0.001*187 + 'px');
document.querySelector(':root').style.setProperty('--height-mockup', document.documentElement.clientWidth*0.001*228 + 'px');

document.querySelector('.homepage_title').style.setProperty('font-size', document.documentElement.clientWidth*2 + '%');
